...
class ManualUploadScreen(Screen):
    CSS_PATH = [
        Path(__file__).parent / "iris_widgets" / "board_widgets" / "AutoBoardInfoPanel.tcss",
        Path(__file__).parent / "iris_widgets" / "board_widgets" / "ManualBoardEntryPanel.tcss",
